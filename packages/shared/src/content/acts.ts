...
export const ENEMY_SKILLS: SkillDef[] = [
  ...
  { id: 'boss.valkyrieCry', cls: 'enemy', kind: 'active', name: { ru: 'Клич валькирии', en: "Valkyrie's Cry" }, target: 'allyAll', cd: 4, effects: [{ t: 'buff', stat: 'atk', value: 0.3, turns: 3 }, { t: 'shield', mult: 0.05, scale: 'hp' }], vfx: 'holy' },
